...
public class nearloca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nearloc);
        ...
        String[] placeTypeList = {"clinic", "hospital"};
        String[] placeNameList = {"Clinic", "Hospital"};
